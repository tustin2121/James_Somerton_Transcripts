...
<from {% include citation for=page.cite.plagiarized.knives_wikipedia at="Aftermath para 1-2" %}>
...
<from {% include citation for=page.cite.plagiarized.knives_wikipedia at="Aftermath para 3" %}>
